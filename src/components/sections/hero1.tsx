...
const Hero1 = () => {
  return (
    <div className="my-6 px-4 md:px-32">
      <p className="text-xs text-center text-blue-700 tracking-widest font-bold">PROMOTIONS</p>
      <p className="text-3xl text-center text-gray-900 tracking-widest font-bold py-6">Our Promotions Events</p>
      <div className="flex flex-col gap-4 lg:flex-row ">
        {/* Left Part */}
        <div className="flex flex-1 flex-col gap-4">
          <div className="flex bg-gray-300 ">
            <div className="py-8 lg:m-4">
              <h3 className="font-bold text-3xl ">GET UP TO <span className="text-4xl">60%</span></h3>
              <p>For the summer season</p>
            </div>
            <Image className="object-cover" src={Card1} alt="card1"></Image>
          </div>
          <div className="bg-neutral-900 py-8 flex flex-col items-center">
            <div className="lg:mx-12">
              <p className="font-bold text-white text-4xl py-4 text-center">
                Get 30% OFF!
              </p>
              <p className="text-white tracking-widest text-lg text-center">
                Use promo Code
              </p>
              <Button className="bg-neutral-700 px-8 md:px-16 tracking-widest text-lg text-white">DINEWEEKENDSALE</Button>
            </div>
          </div>
        </div>
        {/* Right Part */}
        <div className="flex flex-col gap-4 md:flex-row">
          <div className="bg-amber-100 object-fit">
            <div>
          ...
          <div className="bg-violet-200 object-fit">
            <div>
              <p className="tracking-wider mt-6 mx-4">Flex Push Button Bomber</p>
              <div className="text-xl">
